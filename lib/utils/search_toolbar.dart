...
//             icon: Icon(
//               Icons.arrow_back,
//               color: const Color(0x000000).withOpacity(0.54),
//               size: 24,
//             ),
//             onPressed: () {
...
//           child: TextFormField(
//             style: TextStyle(
//                 color: const Color(0x000000).withOpacity(0.87), fontSize: 16),
...
//               hintText: 'Find...',
//               hintStyle: TextStyle(color: const Color(0x000000).withOpacity(0.34)),
//             ),
//             onChanged: (text) {
