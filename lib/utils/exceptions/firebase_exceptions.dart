class SMFirebaseException implements Exception {
  final String code;

  SMFirebaseException(this.code);

  String get message {
    switch (code) {
      case 'unknown':
        return 'Terjadi kesalahan firebase yang tidak diketahui. Mohon ulangi lagi';
      case 'invalid-custom-token':
        return 'Format token khusus salah. Mohon periksa token khusus Anda';
      case 'custom-token-mismatch':
        return 'token khusus sesuai dengan pengguna yang berbeda';
      case 'invalid-email':
      ...
      case 'keychain-error':
        return 'Terjadi kesalahan kunci khusus';
      case 'internal-error':
        return 'Terjadi kesalahan internal Firebase';
