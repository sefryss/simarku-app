...
import 'package:simarku/features/donation_book/widgets/donation_book_type_dropdown.dart';
...
class DonationBookTypeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bookController = Get.put(DonationBookController());
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10),
        Obx(() {
          return (bookController.bookType.value ==
                  DonationBookType.physicalBook)
              ? Container()
              : Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
